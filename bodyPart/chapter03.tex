...
%                西南交通大学研究生学位论文：第3章内容
%--------------------------------------------------
\chapter{模板答疑}\label{第3章}

\section{问题反馈}
\label{sec:contact}
关于swjtuThisis模板的一切问题和建议，请发送邮件至\href{mailto:punzunggit@foxmail.com}{punzunggit@foxmail.com}，本人将会及时处理并把重要的问题放入本章节中，供使用者参考。
...
\subsection{模板问题}
\begin{enumerate}
	\item[Q1:]论文编译出来的.pdf文件中所有超链接都没有颜色，怎么更好地区分超链接和普通文本，检查该超链接的地方是否均已经采用超链接？
	\item[A1:]在swjtuThesis.sty文件中设定了超链接的颜色，默认的情况下全是黑色（正式版），用户可以暂时修改为彩色（调试版），详情见代码注释。
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=4in]{figures/Q151208_1_Yang.png}
...
\subsection{其它问题}
\begin{enumerate}
	\item[Q1:]为什么标题页面中论文的日期是五月二十八日？
	\item[A1:]纯属作者的私人原因，可以根据自己需求在coverInformation.tex文件中进行修改。
	\item[Q2:]
	\item[A2:]
\end{enumerate}